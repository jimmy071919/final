const shopitem1 = {
    ...
    1: {id:'1',name: '白蘭地', description: '本產品以南投地區在地新鮮柳丁經釀製及橡木桶熟陳後，再與自法國干邑進口 的XO 白蘭地原酒勾兌調和。絲滑細緻甜美的口感散發出成熟柳丁迷人的水果 香氣，與XO 的典雅花果氣息環環相扣，喉間餘韻變化豐富而綿長，層層香氣 恣意盪漾精釆絕倫，值得尊貴的您再三品味。', price: '1200', img: 'BR.jpg'},
    ...
    9: {id:'9',name: '葡萄酒', description: '帶有纖細的果香 - 草莓和覆盆子等漿果香氣交揉，並與淡淡的煙熏類香氣息微妙的平衡。口感柔順而強勁，有著十分和諧悠長的果香尾韻。', price: '190', img: 'gw.jpg'},
    10: {id:'10',name: '米酒', description: '本產品以蓬萊米為原料，循公賣局採阿米洛法製程釀造，蒸餾擷取最佳品質之酒心經稀釋酒精度為22%，再經儲存6個月～1年以上，純米釀造，完全不添加食用酒精，適合喜好原味米釀白酒之消費者使用，酒中帶有濃厚米糧香氣', price: '450', img: 'ricewine.png'},
    ...
    13: {id:'13',name: '香檳酒', description: '由於其明顯的果實感與較厚實的酒體，黑中白搭配各式美食都非常適宜。可以豐厚的魚類、雞鴨禽類，甚至是小牛肉或豬肉等各式主餐都有極佳的加乘效果。', price: '20000', img: 'sp.png'},
    ...
    15: {id:'15',name: '女巫酒', description: '嘿嘿🧙‍♀️嘿嘿🧙‍♀️嘿嘿🧙‍♀️嘿🧙‍♀️嘿嘿🧙‍♀️嘿嘿🧙‍♀️嘿嘿🧙‍♀️。', price: '1245', img: 'witchwine.png'},
    16: {id:'16',name: '琴酒', description: '撲鼻的茉莉花芬芳、紅色莓果軟糖的酸甜，再點綴些許白胡椒辛香，入口可以感受到溫順的草本風味及淡淡紅茶韻味，豐沛的花香於喉間迴盪。，', price: '1500', img: 'jin.jpg'},
    17: {id:'17',name: '常常酒酒', description: 'I wll never bite, I wll never bite the pain (Sour) 눈물 나게 시큼한 맛(Sour) 그런 게 만약 사랑이면맛보고 싶지 않아 I just feel afraidLove is sour, love is sour grapes' , price: '1314', img: 'liz.jpg'},
};
